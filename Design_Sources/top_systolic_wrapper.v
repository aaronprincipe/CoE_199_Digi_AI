...
module top_wrapper #(
    ...
    input  wire [ADDR_WIDTH-1:0]  i_i_addr_end,
    input  wire [ADDR_WIDTH-1:0]  i_w_start_addr,
    input  wire [ADDR_WIDTH-1:0]  i_w_addr_end,
    input  wire [ADDR_WIDTH-1:0]  i_or_addr,
    input  wire        i_or_read_en,
    input  wire [7:0]  i_zero_point,
    input  wire [7:0]  i_input_offset,
    output wire        o_done,
    output wire [31:0] o_word,
    output wire        o_word_valid,
    output wire [ADDR_WIDTH-1:0]  o_word_addr,
    ...
    output wire [ADDR_WIDTH-1:0]  dbg_first_word_addr,
    output wire [31:0] dbg_first_word,
    output wire [ADDR_WIDTH-1:0]  dbg_last_word_addr,
    output wire [31:0] dbg_last_word,

    output wire [15:0] dbg_or_read_count,
    output wire [ADDR_WIDTH-1:0]  dbg_first_or_read_addr,
    output wire [ADDR_WIDTH-1:0]  dbg_last_or_read_addr,
